    ...
    <PageTransition>
      ...
      <section className="relative isolate overflow-hidden h-[80vh] flex items-center">
        ...
        <div className="relative mx-auto max-w-7xl px-6 w-full flex flex-col items-center text-center gap-6">
          ...
          >
            AI-powered waste classification, gamified learning, eco-commerce and
            more — all in one sleek dashboard.
          </motion.p>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24 space-y-16">
        ...
        >
          ...
          <p className="text-gray-300 max-w-2xl">
            Everything you need to recycle smarter, learn faster and live
            greener.
          </p>
        </motion.div>
          ...
          {features.map((feature, index) => (
            <Link to={feature.link} key={feature.title}>
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -5 }}
                className="group border border-white/5 rounded-lg p-6 bg-neutral-900/80 hover:bg-neutral-800 hover:border-lime-400 transition-all duration-300 cursor-pointer"
              >
