...
// import icon2 from "leaflet/dist/images/marker-icon-red.png"
...
// const randomNearbyPoint = (lat, lng, radiusInMeters = 200) => {
//   const radiusInDegrees = radiusInMeters / 111000
//   const randomLat = lat + (Math.random() - 0.5) * 2 * radiusInDegrees
//   const randomLng = lng + (Math.random() - 0.5) * 2 * radiusInDegrees / Math.cos(lat * Math.PI / 180)
...
//           const generatedPoints = Array.from({ length: 4 }, () =>
//             randomNearbyPoint(userPos[0], userPos[1])
//           )
//           setExtraPoints(generatedPoints)
//         },
//         (error) => {
...
//                         }}>
//                           <h4 style={{ margin: '0 0 5px', color: 'blue' }}>Your Current Location</h4>
//                           <p style={{ fontSize: '12px', margin: 0 }}>
//                             This is your location detected by your PC.
//                           </p>
//                         </div>
//                       </Popup>
//                     </Marker>
//                     <Circle center={currentPosition} radius={500} color="blue" />
//                   </>
//                 )}

//                 {extraPoints.map((pos, index) => (
//                   <Marker key={index} position={pos} icon={defaultRedIcon}>
//                     <Popup>
//                       <div style={{
//                         padding: '10px',
//                         borderRadius: '8px',
...
//                         fontFamily: 'sans-serif'
//                       }}>
//                         <h4 style={{ margin: '0 0 5px', color: 'green' }}>Garbage Point {index + 1}</h4>
//                         <p style={{ fontSize: '12px', margin: 0 }}>
//                           Status: Active <br />
//                           Approx. Distance: ~200m
//                         </p>
//                       </div>
//                     </Popup>
//                   </Marker>
...
//                 {currentPosition && extraPoints.map((pos, index) => (
//                   <Polyline key={index} positions={[currentPosition, pos]} pathOptions={{ color: 'red' }} />
//                 ))}
//               </MapContainer>
//             </div>
...
import icon from "leaflet/dist/images/marker-icon.png"
import iconShadow from "leaflet/dist/images/marker-shadow.png"
import iconRed from "/src/assets/marker-icon-red.png"
