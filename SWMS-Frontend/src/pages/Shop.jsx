    ...
    <PageTransition>
      <div className="mx-auto max-w-7xl px-6 py-24 space-y-12">
        ...
        >
          ...
          <p className="text-gray-300 max-w-2xl mx-auto">
            Curated essentials to step up your green game — add to cart,
            explore, repeat.
          </p>
        </motion.div>
            ...
            >
              <div className="relative">
                <img
                  ...
                  alt={product.name}
                  className="aspect-square w-full object-cover rounded-lg group-hover:scale-105 transition-transform duration-300"
                />
                {product.badge && (
                  <div className="absolute top-3 left-3 px-2 py-1 bg-lime-500 text-neutral-950 text-xs font-medium rounded">
                    {product.badge}
